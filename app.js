...
async function init() {
  ...
  initBattle();
  renderAll();
  log("準備完了。敵HPを3倍にし、水上由岐にテスト用グラフィックを入れています。");
}
