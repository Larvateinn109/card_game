...
function spriteContent(card, kind="battle") {
  const url = kind === "icon" ? (card.iconImage || card.battleImage) : (card.battleImage || card.iconImage);
  if (url) {
